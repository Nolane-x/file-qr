...
const apkPath = path.resolve(process.env.FILE_QR_APK || 'release/FileQR-Android-arm64.apk');
...
const appPid = await waitFor(async () => adb(serial, ['shell', 'pidof', packageName], { allowFailure: true }), 10000);
